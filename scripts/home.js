...
//Crear un nuevo elemento "div"
  ...
  newImgElement.src = datos.events[i].image;
...
// Agregar el título del evento al nuevo elemento "div"
  ...
  newTitleElement.textContent = datos.events[i].name;
 ...
 // Agregar la descripción del evento al nuevo elemento "div"
  ...
  newDescElement.textContent = datos.events[i].description;
  ...
  newPrecioElement.textContent = "Price $" + datos.events[i].price;
  newVypElement.appendChild(newPrecioElement);
  let newLinkElement = document.createElement("a");
  newLinkElement.href = `./details.html?id=${datos.events[i]._id}`;
  ...
  newDivElement.setAttribute('data-category', datos.events[i].category);
